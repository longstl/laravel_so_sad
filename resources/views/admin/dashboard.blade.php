            ...
            <ul class="list-unstyled">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Categories</a>
                    <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                        <li><a href="http://127.0.0.1:8000/admin/category">List Category</a></li>
                        <li><a href="http://127.0.0.1:8000/admin/category/create">Add Category</a></li>
                    </ul>
                </li>
                <li><a href="#exampledropdownDropdown1" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Products</a>
                    <ul id="exampledropdownDropdown1" class="collapse list-unstyled ">
                        <li><a href="http://127.0.0.1:8000/admin/product">List Products</a></li>
                        <li><a href="http://127.0.0.1:8000/admin/product/create">Add Products</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
